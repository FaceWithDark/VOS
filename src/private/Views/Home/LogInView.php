...
<body>
    <h1 style="display: flex; justify-content: center; align-items: center;">Hello there, you have <strong style="margin: 0rem 1.25rem; color: coral;">LOG IN</strong> to your account successfully!</h1>
