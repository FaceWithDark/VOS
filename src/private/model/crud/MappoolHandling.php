...
function fetchDeletedBeatmapData($tournamentName, $tournamentRound)
{
    ...
    $deletedBeatmapJsonData = json_decode(file_get_contents(__DIR__ . '/../../resource/DeletedBeatmap.json'), true);
...
if ($tournamentName) {
    ...
    if ($tournamentRound) {
        ...
        $beatmapJsonData = json_decode(file_get_contents(__DIR__ . '/../../resource/Beatmap.json'), true);
