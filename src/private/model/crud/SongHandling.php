...
function fetchCustomSongData($customSongId, $phpDataObject)
{
    ...
    if ($accessToken) {
        ...
        try {
            ...
            $query = "SELECT id FROM vot_custom_song WHERE custom_song_id = :custom_song_id";
...
function storeCustomSongData($customSongData, $tournamentTitle, $tournamentRound, $modType, $phpDataObject)
{
    ...
    // SQL query to store custom song data in the 'vot_custom_song' table
    $query = "INSERT INTO vot_custom_song (tournament_title,
                                            tournament_round,
                                            mod_type,
                                            custom_song_id,
                                            custom_song_url,
...
{
    $query = "SELECT * FROM vot_custom_song WHERE custom_song_id = :custom_song_id";
    $queryStatement = $phpDataObject->prepare($query);
    $queryStatement->bindParam(":custom_song_id", $customSongId, PDO::PARAM_INT);
